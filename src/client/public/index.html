...
<head>
	...
	<script
		type="application/ld+json">[{"@context":"http:\/\/schema.org","@type":"WebSite","name":"Veil Chat","url":"https:\/\/chat.snkms.com\/","alternateName":"\u5929\u591c\u4e4b\u5fc3"}]</script>
	...
	<div class="messageBox">
		<div class="emoji-window dynamic">
			<div class="eHeader">
				...
				<div class="ehRight">
					<div id="eClose">
						<div class="button" data-ripple><img src="https://chat.snkms.com/images/close_black.png" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="additional dynamic">
			<div id="privateChatCreate" class="button big" data-ripple><img
					src="https://chat.snkms.com/images/chatAdd.png" /><span>建立私聊</span></div>
			<div id="privateChatJoin" class="button big" data-ripple><img
					src="https://chat.snkms.com/images/read_more.png" /><span>加入私聊</span></div>
			<br />
			<div id="settings" class="button"><img src="https://chat.snkms.com/images/settings.png" /><span>設定</span>
			</div>
			<div id="publicChat" class="button big" data-ripple><img
					src="https://chat.snkms.com/images/home.png" /><span>返回大廳</span></div>
		</div>
		<div id="container">
			<div title="更多選項" id="add" class="button"><img src="https://chat.snkms.com/images/add.png" /></div>
			<div title="上傳檔案" id="upload" class="button"><label><input type="file" name="fileUpload[]" id="fileUpload"
						multiple /><img src="https://chat.snkms.com/images/upload.png" /></label></div>
